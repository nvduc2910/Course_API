...
namespace Course_API.Infrastructures
{
    public class ApiResponder
    {
        ...
        public static ObjectResult RespondFailureTo(int statusCode, dynamic errors, string errorCode)
        {
            ApiResponder apiResponder = new ApiResponder(null,
                new Error { errorMessage = errors, errorCode = Convert.ToInt32(errorCode) });

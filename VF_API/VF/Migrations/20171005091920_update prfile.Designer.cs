...
namespace Course_API.Migrations
{
    ...
    [Migration("20171005091920_update prfile")]
    partial class updateprfile
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("VF_API.Models.CharterCapital", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VF_API.Models.ProductionCapacity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VF_API.Models.Profile", b =>
                {
                    ...
                    b.Property<string>("TypicalProduct");
            ...
            modelBuilder.Entity("VF_API.Models.Revenue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VF_API.Models.Profile", b =>
                {
                    ...
                    b.HasOne("VF_API.Models.CharterCapital", "CharterCapital")
                        .WithMany()
                        .HasForeignKey("CharterCapitalId");

                    b.HasOne("VF_API.Models.CompanySize", "CompanySize")
                        .WithMany()
                        .HasForeignKey("CompanySizeId");

                    b.HasOne("VF_API.Models.Market", "Market")
                        .WithMany()

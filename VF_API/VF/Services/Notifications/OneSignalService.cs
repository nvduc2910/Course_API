...
namespace Course_API.Services.Notifications
{
    public class OneSignalService
    {
        ...
        // //public async void PushNotification(Message message, string userName, string deviceId, string receiveId)
        // {
        //    //try
        //    //{
        ...
        //    //            contents = new { en = userName + ": " + message.Text },
        //    //            data = new { receiveId  = receiveId },
